    ...
    public void runOpMode() throws InterruptedException{
        ...
        switch(position){
            case LEFT:
                ...
                f2.turnToHeading(Math.toRadians(180), null, 2000);
                if(isStopRequested()){
                    return;
                }
                ...
                f2.driveToPoint(new Vector2(0, -600),null, 3000);
                if(isStopRequested()){
                    return;
                }
                ...
                f2.setStartSpeed(0.7);
                f2.setCruiseSpeed(0.8);
                f2.setCrawlSpeed(0.4);

                f2.driveToPoint(new Vector2(-900, 0), null, 4000);
                if(isStopRequested()){
                    return;
                }
            ...
            case CENTER:
                ...
                f2.turnToHeading(Math.toRadians(-57));
                if(isStopRequested()){
                    return;
                }
                ...
                f2.driveToPoint(new Vector2(0, -900), null, 3500);
                if(isStopRequested()){
                    return;
                }
            ...
            case RIGHT:
                ...
                f2.turnToHeading(Math.toRadians(-45));
                if(isStopRequested()){
                    return;
                }
                ...
                f2.driveToPoint(new Vector2(0, -800), null, 3500);
                if(isStopRequested()){
                    return;
                }
