...
public class RedVisionPipeline extends OpenCvPipeline {
    ...
    static final Point LEFT_REGION_ANCHOR_POINT = new Point(250 * X_SCALE_FACTOR,90 * Y_SCALE_FACTOR);//was 500, 105
    static final Point CENTER_REGION_ANCHOR_POINT = new Point(700 * X_SCALE_FACTOR, 90 * Y_SCALE_FACTOR);
